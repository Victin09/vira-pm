          ...
          <div className="flex justify-between w-full mb-2">
            <div className="flex items-center">
              ...
              <span className="w-full ml-1">
                {memberCount} {memberCount > 1 ? "miembros" : "miembro"}
              </span>
            </div>
            <button
              className="btn btn-primary"
              onClick={() => mutation.mutate(selectedGuild!.id)}
            >
              {mutation.isLoading ? (
                <svg
                  role="status"
                  className="w-8 h-8 mr-2 text-primary animate-spin fill-base-100"
                  viewBox="0 0 100 101"
                  fill="none"
            ...
            <div>
              <div>
                <h3 className="font-bold mb-1">
                  Envía este enlace a las personas que quieras invitar!
                </h3>
